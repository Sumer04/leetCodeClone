 ...
 const handleSubmit =async ()=>
  {
    ...
    try{
     ...
     if(typeof handler==="function")
     {
      ...
      if(success)
     {
      toast.success("Congrates all tests case passed!",{
        position:"top-center",
        autoClose:3000,
        theme:'dark'
      })
  ...
  {
   setUserCode(value);
   localStorage.setItem(`cpde-${pid}`,JSON.stringify(value));
  }
  return (
             ...
             <div className='w-full px-5-overflow-auto'>
               <div className='flex h-10 items-center space-x-6'>
                  <div className='relative flex h-full flex-col justify-center cursor-pointer'>
                      <div className='text-sm font-medium leading-5 text-white'>Testcases</div><br/>
