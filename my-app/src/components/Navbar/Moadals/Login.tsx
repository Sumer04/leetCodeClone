...
const Login:React.FC<LoginProps> = () => {
    ...
    const handler =(type : "login" | "register" | "forgotPassword") =>
    {
  ...
  toast.error(error.message,{position :"top-center",autoClose:3000,theme:"dark"});
    ...
    return (
        ...
        <input onChange={handleInputChange} type="email" name="email" id="email" className="border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder='Sumersingh@gmail.com'/>
        ...
        <button className="flex w-full justify-end">
            <a href='#' className='text-sm block text-brand-orange hover:underline w-full text-right ' onClick={()=>handler("forgotPassword")}>Forgot Password</a>
        </button>
        <div className="text-sm font-medium text-gray-500">Not Registered ?
        <a href="#" className='text-blue-700 hover:underline' onClick={()=> handler("register")}>Create account </a>
        </div>
        </form>
