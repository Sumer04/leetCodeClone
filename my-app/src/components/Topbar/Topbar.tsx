...
// import Login from '../Navbar/Moadals/Login';
           ...
           <div className = {`flex w-full items-center justify-between ${!problemPage ? "max-w-[1200px} mx-auto" : ""}`}>
            ...
            {problemPage && (
                <div className='flex items-center gap-4 flex-1 justify-center'>
                   ...
                   <Link href ="/" className='flex items-center gap-2 font-medium max-w0[170px] text-dark-gray-8 cursor-pointer' >
                    <div>
                        <BsList/>
                    </div>
                    <p> Problem List</p>
            ...
            <div className='flex items-center space-x-4 flex-1 justify-end'>
                <div>
                    <a href="https://ww.buymeacoffe.com/burakorkezz" target='_blank' rel ="noreferrer" className='bg-dark-fill-3 py-1.5 px-3  cursor-pointer rounded text-brand-orange hover:bg-dark-fill-2'>Premium</a>
                </div>
            ...
            <Link href ='/auth' onClick={()=>{
                ...
                <button className='bg-dark-fill-3 py-1.5 px-3 cursor-pointer rounded text-brand-orange hover:bg-dark-fill-2'>Sign in</button>
            </Link>
            )}
