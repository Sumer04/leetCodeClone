...
const Timer: React.FC<TimerProps> = () => {
    ...
    const formaTime = (time:number): string =>{
    ...
    return <div>
        {showtimer ? (
            <div className='flex items-center space-x-2 bg-dark-fill-2 py-1 cursor-pointer rounded hover:bg-dark-fill-2
        '>
                <div> {formaTime(time)}</div>
