...
const Signup:React.FC<SignupProps> = () => {
    ...
    return(
        ...
        <input  onChange ={handleChangeInput} type="email" name="email" id="email" className="border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder='Sumersingh@gmail.com'/>
        
        </div>
        <div>
            <label htmlFor='display' className='text-sm font-medium block mb-2 text-gray-300'>Display Name</label>
        <input   onChange ={handleChangeInput} type="display" name="display" id="display" className="border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder='Sumer Singh'/>
       ...
       {loading ? "Registering..." : "Register"}
        ...
        <a href="#" className='text-blue-700 hover:underline' onClick={handler}>Log in</a>
        </div>
        </form>
    )
}
